...
const { selectedRecipients } = defineProps<{ selectedRecipients: number[] }>();
...
<template>
  <div class="flex items-center gap-2">
    ...
    <Button
      size="icon"
      class="bg-blue-500"
      @click="performAction('export_pdf')"
      :disabled="!selectedRecipients.length">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
    ...
    <Button
      size="icon"
      class="bg-green-500"
      @click="performAction('export_excel')"
      :disabled="!selectedRecipients.length">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
    ...
    <Button
      size="icon"
      class="bg-yellow-500"
      @click="performAction('export_csv')"
      :disabled="!selectedRecipients.length">
    ...
    <!-- Edit Single Recipient Button -->
    <Button
      size="icon"
      class="bg-purple-500"
      @click="performAction('edit')"
      :disabled="! selectedRecipients.length || selectedRecipients.length > 1">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
